...
def main():
    ...
    temp = [('EC-47', 52865), ('RF-4', 242231), ('A-1', 358498), ('A-37', 267457), ('F-4', 909362), ('A-4', 372975), ('A-7', 165773), ('CH-53', 4339), ('O-1', 50843), ('UH-1', 146543), ('C-7', 13769), ('A-6', 144601), ('EB-66', 34738), ('T-28', 41655), ('C-123', 20604), ('CH-47', 9286),
    ...
    print(max(temp, key=lambda x: x[1])[1])
